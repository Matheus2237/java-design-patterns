...
public class VinteReaisDispenser implements DispenserChain {

	private DispenserChain nextInChain;

	@Override
	public void dispense(BigInteger value, Receipt receipt) {
		long quantityOfBills = value.divide(BigInteger.valueOf(20)).longValue();
		receipt.receiveBills(20, quantityOfBills);
		nextInChain.dispense(value.remainder(BigInteger.valueOf(20)), receipt);
	}
