...
public class CincoReaisDispenser implements DispenserChain {

	private DispenserChain nextInChain;

	@Override
	public void dispense(BigInteger value, Receipt receipt) {
		long quantityOfBills = value.divide(BigInteger.valueOf(5)).longValue();
		receipt.receiveBills(5, quantityOfBills);
		nextInChain.dispense(value.remainder(BigInteger.valueOf(5)), receipt);
	}
